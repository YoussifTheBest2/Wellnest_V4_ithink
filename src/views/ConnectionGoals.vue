<template>
    <ion-page>
      <ion-header>
        ...
        <center><h1>Connection Goals</h1></center>
      </ion-toolbar>
      </ion-header>
      ...
      <ion-content class="ion-padding" color="light">
        <ion-list lines="none">
          <ion-card>
            <ion-card-header>
              <ion-card-title>Add Goal</ion-card-title>
            </ion-card-header>
            <ion-card-content>
              <ion-item>
                <ion-label position="stacked">Item Title</ion-label>
                <ion-input v-model="newEvent.title" placeholder="e.g., Meeting up with Friends"></ion-input>
              </ion-item>
